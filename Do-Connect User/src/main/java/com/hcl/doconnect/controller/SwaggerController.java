...
public class SwaggerController {
...

	{
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).groupName("DoConnect API").select()
				.apis(RequestHandlerSelectors.basePackage("com.hcl.doconnect.controller")) // whose methods do you want to
																						// add
	...
	private ApiInfo apiInfo() { // used this object to store the meta data
		...
		return new ApiInfoBuilder().title("DoConnect User API").description("DoConnect testing controller APIs")
